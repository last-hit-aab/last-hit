	...
	const god = () => {
		...
		const transformEvent = (e, element) => {
			...
			return {
				...
				detail: e.detail,
				/** positions */
				clientX: e.clientX || (e.touches && e.touches.length > 0 && e.touches[0].clientX),
				clientY: e.clientY || (e.touches && e.touches.length > 0 && e.touches[0].clientY),
				pageX: e.pageX || (e.touches && e.touches.length > 0 && e.touches[0].pageX),
				pageY: e.pageY || (e.touches && e.touches.length > 0 && e.touches[0].pageY),
				screenX: e.screenX || (e.touches && e.touches.length > 0 && e.touches[0].screenX),
				screenY: e.screenY || (e.touches && e.touches.length > 0 && e.touches[0].screenY),
