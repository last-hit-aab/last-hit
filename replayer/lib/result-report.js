						...
						content: [
							{
								type: 'img',
								attributes: {
									src: `screen-record\\${ci_result.flowName}\\${step.stepUuid}_baseline.png`,
						...
						content: [
							{
								type: 'img',
								attributes: {
									src: `screen-record\\${ci_result.flowName}\\${step.stepUuid}_replay.png`,
									style: 'width:500px;height:300px;'
								}
							}
						]
						...
						content: [
							{
								type: 'img',
								attributes: {
									src: `screen-record\\${ci_result.flowName}\\${step.stepUuid}_diff.png`,
									style: 'width:500px;height:300px;'
								}
							}
						]
